...
function ms_home_slider() {
  ...
  if ($.exists(".swiper-container1")) {
    ...
    $(".expanded-timeline__counter span:last-child").text(
    ...
    $("#validForm").validate({
      ...
      messages: {
        name: {
          ...
          minlength:
            "<span>Your name must consist of at least 2 characters</span>",
        ...
        message: {
          ...
          minlength:
            "<span>Your message must consist of at least 16 characters</span>",
