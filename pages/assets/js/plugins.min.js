  ...
  (r.prototype = {
    ...
    (i.fn.filterizr.prototype = {
      ...
      search: function (t) {
        ...
        if (i._isSearchActivated())
          for (e = 0; e < r.length; e++)
            r[e].text().toLowerCase().indexOf(t.toLowerCase()) > -1 &&
              n.push(r[e]);
      ...
      _makeSubarrays: function () {
        ...
        for (r = 0; r < t._mainArray.length; r++)
          if ("object" == typeof t._mainArray[r]._category)
            for (var n = t._mainArray[r]._category.length, e = 0; e < n; e++)
      ...
      _handleFiltering: function (t) {
        for (
          var i = this, r = i._getArrayOfUniqueItems(i._activeArray, t), n = 0;
          n < r.length;
          n++
        )
          r[n]._filterOut();
  ...
  var n = {
    ...
    _filterIn: function (t) {
      ...
      i(r).removeClass("filteredOut"),
        ...
        (n.transform += " translate3d(" + t.left + "px," + t.top + "px, 0)"),
        r.css(n);
    },
  };
})(this, jQuery);
...
function UGFunctions() {
  ...
  (this.debugVar = ""),
          ...
          (u = a),
            ...
            o > l
              ? ((l = o),
                (u = l / c),
                (_ = 0),
                (d = Math.round(((u - a) / 2) * -1)))
              : ((d = 0), (_ = Math.round(((l - o) / 2) * -1)));
        } else {
          var c = t / i;
          (u = a),
            (l = u * c),
    ...
    (this.getElementCenterPosition = function (e, t) {
      ...
      var l = {};
      return (
        (l.left = Math.round((a - r.width) / 2)),
        (l.top = Math.round((s - r.height) / 2)),
    ...
    (this.cloneElementSizeAndPos = function (e, t, n, r, o) {
      ...
      n === !0
        ? ((a.height = e.outerHeight()), (a.width = e.outerWidth()))
    ...
    (this.placeImageInsideParent = function (e, t, n, r, o, a) {
      var s = i.getImageInsideParentData(t, n, r, o, a),
        l = "<img";
      null !== s.imageWidth &&
        ((l += " width = '" + s.imageWidth + "'"),
        (s.style += "width:" + s.imageWidth + ";")),
        null != s.imageHeight &&
          ("100%" == s.imageHeight
            ? ((l += " height = '" + s.imageHeight + "'"),
              (s.style += "height:" + s.imageHeight + ";"))
            : ((l += " height = '" + s.imageHeight + "'"),
              (s.style += "height:" + s.imageHeight + "px;"))),
    ...
    (this.scaleImageCoverParent = function (e, t, n) {
      ...
      var a = i.getImageOriginalSize(e),
        ...
        c = 0;
      r > _
        ? ((_ = r), (d = _ / u), (c = 0), (g = Math.round(((d - o) / 2) * -1)))
        : ((g = 0), (c = Math.round(((_ - r) / 2) * -1))),
        (_ = Math.round(_)),
        (d = Math.round(d)),
        e.css({
          width: _ + "px",
    ...
    (this.scaleImageFitParent = function (e, t, n, r, o) {
      ...
      return (
        null !== s.imageWidth &&
          ((l = !0), e.removeAttr("width"), (u.width = s.imageWidth + "px")),
        null != s.imageHeight &&
          ((l = !0), e.removeAttr("height"), (u.height = s.imageHeight + "px")),
    ...
    (this.scaleImageExactSizeInParent = function (e, t, n, r, o, a) {
      ...
      (I.width = d + "px"),
        ...
        (I["padding-left"] = g + "px"),
        (I["padding-top"] = h + "px"),
        (I["padding-right"] = c + "px"),
        (I["padding-bottom"] = p + "px"),
        e.css(I);
      var w = {};
    ...
    (this.normalizeSetting = function (e, t, i, n, r, o) {
      ...
      var a = (r - i) / (n - i);
      return (
        (r = e + (t - e) * a), 1 == o && (e > r && (r = e), r > t && (r = t)), r
      );
    }),
    ...
    (this.updateStoredEventData = function (e, t, r) {
      ...
      (o.lastTime = jQuery.now()),
        void 0 !== a.pageX &&
          ((o.lastMouseX = a.pageX),
          (o.lastMouseY = a.pageY),
          (o.lastMouseClientY = a.clientY)),
        r && (o = jQuery.extend(o, r)),
        (n.dataCache[t] = o);
    }),
      ...
      e.on("tap", t),
        0 == i.isTouchDevice()
          ? e.on("click", function (e) {
              var t = jQuery(this);
              return 0 == i.validateClickTouchstartEvent(e.type)
                ? !0
                : void t.trigger("tap");
            })
          : (e.on("touchstart", function (e) {
...
function UGThumbsGeneral() {
  function e(e, t) {
    ...
    if (1 == j.thumb_wrapper_as_link) {
      ...
      var a =
        "<a href='" + s + "'" + l + " class='ug-thumb-wrapper" + n + "'></a>";
    }
    var u = jQuery(a),
      d = i.objThumbImage;
    if (0 == C.customThumbs) {
      if (1 == j.thumb_show_loader && d) {
        ...
        "bright" == j.thumb_loader_type && (_ = "ug-thumb-loader-bright"),
          u.append("<div class='ug-thumb-loader " + _ + "'></div>"),
  ...
  function t(e, t, i, n) {
    ...
    i
      ? (n !== !0 && i.css(r), i.find(a).css(o))
      : (E.children(".ug-thumb-wrapper").css(r), E.find(a).css(o));
  }
  function i(e, t, i, n) {
    if (!n) var n = !1;
    ...
    (o["border-width"] = t + "px"),
      ...
      n && n === !0
        ? (r.css(o), 0 == t ? r.hide() : r.show())
        : (0 == t
            ? r.stop().fadeOut(j.thumb_transition_duration)
            : r.show().stop().fadeIn(j.thumb_transition_duration),
          l(r, o));
  }
  function n(e, t, i) {
    ...
    i && i === !0 && (r = 0),
      t ? n.stop(!0).fadeTo(r, C.colorOverlayOpacity) : n.stop(!0).fadeTo(r, 0);
  }
  function r(e, t, i) {
    ...
    i && i === !0 && (o = 0),
      t ? r.stop(!0).fadeTo(o, 1) : (n.fadeTo(0, 1), r.stop(!0).fadeTo(o, 0));
  }
  function o(e, t) {
    if (
      (C.isEffectBorder &&
        i(e, j.thumb_selected_border_width, j.thumb_selected_border_color, t),
      C.isEffectOverlay)
    ) {
  ...
  function a(e) {
    ...
    return (
      ...
      1 == C.customThumbs
        ? (S.trigger(T.events.IMAGELOADERROR, e), !0)
  ...
  function d(e, i, n) {
    if (1 == j.thumb_fixed_size) x.scaleImageCoverParent(i, e);
      ...
      "height" == j.thumb_resize_by
        ? x.scaleImageByHeight(i, j.thumb_height)
        : x.scaleImageByWidth(i, j.thumb_width);
      var r = x.getElementSize(i);
      x.placeElement(i, 0, 0), t(r.width, r.height, e);
    }
    e.children(".ug-thumb-loader").hide(),
      i.show(),
      0 == j.thumb_image_overlay_effect
        ? i.fadeTo(0, 1)
        : (1 == j.thumb_image_overlay_effect && _(i), i.fadeTo(0, 0), u(e)),
      S.trigger(T.events.AFTERPLACEIMAGE, e);
  }
  function _(e) {
  ...
  function p(e) {
    return 1 == C.touchEnabled
      ? (objThumbs.off("mouseenter").off("mouseleave"), !0)
      : void (0 == c(e) && T.setThumbOverStyle(e));
  }
  function f(e) {
    return 1 == C.touchEnabled
      ? !0
      : void (0 == c(e) && T.setThumbNormalStyle(e, !1));
  }
  function m(e, t) {
    if (!t) var t = !1;
    var i = jQuery(e),
    ...
    return 0 == n.parent().length
      ? !1
      : ((objItem = T.getItemByThumb(n)),
        1 == objItem.isLoaded && t === !1
          ? !1
          : (T.triggerImageLoadedEvent(n, i),
            void (1 == C.customThumbs
              ? S.trigger(T.events.PLACEIMAGE, [n, i])
              : d(n, i, objItem))));
  }
  function v(e, t, i) {
    (objItem = T.getItemByThumb(t)),
      (objItem.isLoaded = !0),
  ...
  (this.init = function (e, t) {
    ...
    (this.setThumbNormalStyle = function (e, t, o) {
      if (
        (1 == C.customThumbs && e.removeClass("ug-thumb-over"),
        C.isEffectBorder && i(e, j.thumb_border_width, j.thumb_border_color, t),
        C.isEffectOverlay)
      ) {
    ...
    (this.setThumbOverStyle = function (e) {
      if (
        (1 == C.customThumbs && e.addClass("ug-thumb-over"),
        C.isEffectBorder &&
          i(e, j.thumb_over_border_width, j.thumb_over_border_color),
        C.isEffectOverlay)
      ) {
    ...
    (this.setHtmlProperties = function (e) {
      ...
      if (
        ...
        if (x.isRgbaSupported()) {
          var n = x.convertHexToRGB(
            j.thumb_overlay_color,
            j.thumb_overlay_opacity
          );
          i["background-color"] = n;
        } else
          (i["background-color"] = j.thumb_overlay_color),
            (C.colorOverlayOpacity = j.thumb_overlay_opacity);
    ...
    (this.setThumbSelected = function (e) {
      return (
        1 == C.customThumbs && e.removeClass("ug-thumb-over"),
        1 == c(e) ? !0 : (e.addClass("ug-thumb-selected"), void o(e))
      );
    }),
    (this.setThumbUnselected = function (e) {
      e.removeClass("ug-thumb-selected"),
        T.setThumbNormalStyle(e, !1, "set unselected");
    }),
    ...
    (this.setCustomThumbs = function (e, t, i) {
      if (((C.customThumbs = !0), "function" != typeof e))
    ...
    (this.destroy = function () {
      var e = ".ug-thumb-wrapper";
      E.off("touchstart", e),
        I.off(A.eventSizeChange),
        E.off("mouseenter", e),
        E.off("mouseleave", e),
        S.off(T.events.THUMB_IMAGE_LOADED);
    }),
...
function UGThumbsStrip() {
  ...
  function t() {
    var e = N.getOptions();
    (R.isNotFixedThumbs = e.thumb_fixed_size === !1),
      (H = k.strip_vertical_type);
  }
  function n() {
    N.setHtmlProperties(),
      ...
      s(),
      0 == R.isRunOnce &&
        (1 == k.strip_control_touch &&
          ((M = new UGTouchThumbsControl()), M.init(O)),
        1 == k.strip_control_avia && ((A = new UGAviaControl()), A.init(O)),
        p(),
        N.loadThumbsImages(),
        y()),
      (R.isRunOnce = !0);
  ...
  function r(e) {
    (G.stripSize = e),
      0 == H
        ? (G.stripActiveSize =
            G.stripSize - k.strip_padding_left - k.strip_padding_right)
        : (G.stripActiveSize =
            G.stripSize - k.strip_padding_top - k.strip_padding_bottom),
  ...
  function o() {
    ...
    0 == H
      ? ((G.thumbSize = i),
        1 == o.thumb_fixed_size
          ? (G.thumbSecondSize = n)
          : (G.thumbSecondSize = o.thumb_height),
        r(j.width()),
        (G.stripInnerSize = C.width()))
      : ((G.thumbSize = n),
        1 == o.thumb_fixed_size
          ? (G.thumbSecondSize = i)
          : (G.thumbSecondSize = o.thumb_width),
        r(j.height()),
        (G.stripInnerSize = C.height()));
  }
  function a(e) {
    0 == H ? C.width(e) : C.height(e),
      (G.stripInnerSize = e),
      p(),
      jQuery(O).trigger(O.events.INNER_SIZE_CHANGE);
  }
  function s() {
    var e = C.children(".ug-thumb-wrapper"),
      t = 0,
    ...
    for (0 == H && (n = k.strip_padding_top), i = 0; i < e.length; i++) {
      ...
      L.placeElement(r, t, n),
        0 == H
          ? (t += r.outerWidth() + k.strip_space_between_thumbs)
          : (n += r.outerHeight() + k.strip_space_between_thumbs);
    }
  ...
  function f() {
    return I()
      ? !1
      : void (0 == H
          ? L.placeElement(C, k.strip_thumbs_align, 0)
          : L.placeElement(C, 0, k.strip_thumbs_align));
  }
  function m(e) {
  ...
  function w() {
    ...
    return (
      ...
      (e.maxPosThumbs = -1 * t + G.stripSize - 1),
      e
    );
  }
  function E(e) {
    ...
    return (
      0 == H
        ? ((t.min = i.left), (t.max = i.left + G.thumbSize))
        : ((t.min = i.top), (t.max = i.top + G.thumbSize)),
      t
    );
  }
  var T,
  ...
  (this.setHtml = function (e) {
    ...
    (this.destroy = function () {
      ...
      e.off("click"),
        e.off("touchend"),
        T.off(z.events.ITEM_CHANGE),
        jQuery(N).off(N.events.AFTERPLACEIMAGE),
        M && M.destroy(),
        A && A.destroy(),
        N.destroy();
    }),
    ...
    (this.getInnerStripLimits = function () {
      ...
      return (
        0 == H
          ? (e.maxPos = k.strip_padding_left)
          : (e.maxPos = k.strip_padding_top),
        (e.minPos = -(G.stripInnerSize - G.stripActiveSize)),
        e
      );
    }),
    ...
    (this.resize = function (e) {
      0 == H
        ? (j.width(e),
          (G.stripActiveSize =
            e - k.strip_padding_left - k.strip_padding_right))
        : (j.height(e),
          (G.stripActiveSize =
            e - k.strip_padding_top - k.strip_padding_bottom)),
        r(e),
        p(),
        h(),
        f(),
...
function UGTouchThumbsControl() {
  function e() {
    var e = jQuery.now(),
      t = {};
    return (
      (t.passedTime = T.lastTime - T.startTime),
      (t.lastActiveTime = e - T.buttonReleaseTime),
      (t.passedDistance = T.lastPos - T.startPos),
      (t.passedDistanceAbs = Math.abs(t.passedDistance)),
      t
    );
  }
  function t() {
    E.thumb_touch_slowFactor = w.normalizeSetting(
      5e-5,
      0.01,
      1,
      100,
  ...
  function r(e) {
    ...
    (T.mousePos = e),
      ...
      (T.lastDeltaTime = 0),
      (T.lastDeltaPos = 0),
      (T.startTime = jQuery.now()),
      (T.startPos = T.innerPos),
      (T.lastTime = T.startTime),
      (T.lastPos = T.startPos),
      (T.speed = 0);
  }
  function o() {
    var e = jQuery.now(),
    ...
    t >= E.touch_portion_time &&
      ((T.lastDeltaTime = e - T.lastTime),
      T.lastDeltaTime > E.touch_portion_time &&
        (T.lastDeltaTime = E.touch_portion_time),
      (T.lastDeltaPos = T.lastPos - T.lastPortionPos),
      (T.lastPortionPos = T.lastPos),
      (T.lastTime = e));
  }
  function a() {
    ...
    t > o &&
      T.lastDeltaTime > 0 &&
      ((o = T.lastDeltaTime), (a = T.lastDeltaPos + a)),
      t > o && (o = t);
    var l = a > 0 ? 1 : -1,
      u = 0;
    o > 0 && (u = a / o);
  ...
  function l() {
    return 1 == T.loop_active
      ? !0
      : ((T.loop_active = !0), void (T.handle = setInterval(o, 10)));
  }
  function u(e) {
  ...
  function d(e) {
    return 0 == T.isControlEnabled
      ? !0
      : ((T.buttonReleaseTime = jQuery.now()),
        0 == T.touch_active
          ? (u(e), !0)
          : (e.preventDefault(),
            (T.touch_active = !1),
...
function UGPanelsBase() {
  ...
  (this.init = function (e, t, i, o, l) {
    ...
    (this.openPanel = function (a) {
      if (!a) var a = !1;
      return o.is(":animated")
        ? !1
        : 0 == n.isClosed
        ? !1
        : ((n.isClosed = !1),
          s.trigger(r.events.OPEN_PANEL),
          void (a === !1 ? e(n.originalPos, i) : (t(n.originalPos), i())));
    }),
    (this.closePanel = function (a) {
      ...
      (n.isClosed = !0),
        s.trigger(r.events.CLOSE_PANEL),
        a === !1 ? e(l, i) : (t(l), i());
    }),
  ...
  function n(e) {
    return (
      ...
      0 == l.validateClickTouchstartEvent(e.type)
        ? !0
        : void (a.isPanelClosed() ? a.openPanel() : a.closePanel())
    );
  }
  function r() {
  ...
  (this.init = function (e, t, i, n, r) {
    ...
    (this.setHtml = function () {
      ...
      o.append(
        ...
        (s = o.children(".ug-panel-handle-tip"));
    }),
    (this.initEvents = function () {
      l.addClassOnHover(s),
        s.bind("click touchstart", n),
...
function UGStripPanel() {
  function e(e, t) {
    ...
    var i = !1;
    1 == j.strippanel_vertical_type && ((j = jQuery.extend(j, C)), (i = !0)),
      0 == j.strippanel_enable_buttons && ((j = jQuery.extend(j, A)), (i = !0)),
      1 == i && (j = jQuery.extend(j, t));
    var n = T.getOptions(),
      r = n.gallery_skin;
    "" == j.strippanel_buttons_skin && (j.strippanel_buttons_skin = r),
      (v = T.getElement()),
      x.init(T, M, w, j, E),
      (P = new UGThumbsStrip()),
      P.init(T, j);
  ...
  function i() {
    return 1 == M.isFirstRun && 0 == t()
      ? !1
      : (P.run(), s(), d(), f(), (M.isFirstRun = !1), void c());
  }
  function n(e) {
    if (!e) var e = v;
    if (
    ...
    x.setHtml(b),
      P.setHtml(b),
      1 == j.strippanel_enable_buttons &&
        ((I = b.children("." + t)), (y = b.children("." + i))),
      r();
  }
  function r() {
    "" != j.strippanel_background_color &&
      b.css("background-color", j.strippanel_background_color);
  }
  function o() {
    var e = P.getHeight(),
      t = M.panelWidth;
  ...
  function l() {
    y &&
      (S.placeElement(
        ...
        "left",
        "top",
        j.strippanel_padding_left,
        j.strippanel_padding_top
      ),
      S.placeElement(
        y,
        "right",
        "top",
        j.strippanel_padding_right,
        j.strippanel_padding_top
      ));
    var e = j.strippanel_padding_left;
    y && (e += y.outerWidth() + j.strippanel_padding_buttons),
      P.setPosition(e, j.strippanel_padding_top);
  }
  function u() {
    y &&
      (S.placeElement(
      ...
      S.placeElement(
        ...
        "bottom",
        j.strippanel_padding_left,
        j.strippanel_padding_bottom
      ));
    var e = j.strippanel_padding_top;
    y && (e += y.outerHeight() + j.strippanel_padding_buttons),
      P.setPosition(j.strippanel_padding_left, e);
  }
  function d() {
    0 == j.strippanel_vertical_type ? l() : u(), x.placeElements();
  }
  function _(e) {
    return S.isButtonDisabled(e)
      ? !0
      : void ("advance_item" == j.strippanel_buttons_role
          ? T.nextItem()
          : P.scrollForeward());
  }
  function g(e) {
  ...
  function c() {
    ...
    t >= e.maxPos ? S.disableButton(I) : S.enableButton(I),
      t <= e.minPos ? S.disableButton(y) : S.enableButton(y);
  }
  function h() {
    c();
  }
  function p() {
    T.isLastItem() ? S.disableButton(y) : S.enableButton(y),
      T.isFirstItem() ? S.disableButton(I) : S.enableButton(I);
  }
  function f() {
    if (1 == M.isEventsInited) return !1;
    if (((M.isEventsInited = !0), y))
      if (
        (S.addClassOnHover(y, "ug-button-hover"),
        S.addClassOnHover(I, "ug-button-hover"),
        S.setButtonOnClick(I, g),
        S.setButtonOnClick(y, _),
        "advance_item" != j.strippanel_buttons_role)
      )
        jQuery(P).on(P.events.STRIP_MOVE, h),
          jQuery(P).on(P.events.INNER_SIZE_CHANGE, c),
          m.on(T.events.SIZE_CHANGE, c);
      else {
        var e = T.getOptions();
  ...
  (this.destroy = function () {
    y &&
      (S.destroyButton(y),
      S.destroyButton(I),
      jQuery(P).off(P.events.STRIP_MOVE),
      jQuery(T).off(T.events.ITEM_CHANGE),
      jQuery(T).off(T.events.SIZE_CHANGE)),
      x.destroy(),
      P.destroy();
  }),
...
function UGGridPanel() {
  function e(e, i) {
    (x = e),
      ...
      (M = jQuery.extend(M, i)),
      1 == L.isHorType
        ? ((M = jQuery.extend(M, z)), (M = jQuery.extend(M, i)))
  ...
  function r() {
    "" != M.gridpanel_background_color &&
      w.css("background-color", M.gridpanel_background_color);
  }
  function o() {
  ...
  function s() {
    ...
    var n = j.getElementSize(E),
      r = n.width;
    return (
      (e += 2 * (r + M.gridpanel_arrows_padding_hor)), (t = L.panelWidth - e)
    );
  }
  function l() {
    var e = !1;
    ...
    1 == e
      ? (E.show().fadeTo(0, 1), T.show().fadeTo(0, 1), (L.arrowsVisible = !0))
      : (E.hide(), T.hide(), (L.arrowsVisible = !1));
  }
  function u() {
    var e = C.getSize();
    1 == L.isHorType
  ...
  function d() {
    return 1 == L.isEventsInited
      ? !1
      : ((L.isEventsInited = !0),
        T && (j.addClassOnHover(T), C.attachPrevPaneButton(T)),
        E && (j.addClassOnHover(E), C.attachNextPaneButton(E)),
        void A.initEvents());
  }
  function _() {
    ...
    switch (M.gridpanel_grid_align) {
      case "middle":
        switch (M.gridpanel_arrows_align_vert) {
          ...
          case "borders":
            var l =
              L.panelHeight - r.height - M.gridpanel_padding_border_bottom;
            a = (l - o.height) / 2;
        }
        break;
      case "bottom":
  ...
  function m() {
    ...
    var a = C.getElement();
    switch (
      (j.placeElement(a, e, M.gridpanel_padding_border_top),
      (o = C.getSize()),
  ...
  function y() {
    0 == L.isHorType ? (1 == M.gridpanel_vertical_scroll ? h() : f()) : b(),
      A.placeElements();
  }
  var I,
    w,
...
function UGThumbsGrid() {
  function e(e, t, i) {
    if (
      ((N = e.getObjects()),
      (B = e),
      B.attachThumbsPanel("grid", Q),
      (H = jQuery(e)),
      (k = N.g_objWrapper),
      (R = N.g_arrItems),
      i === !0 && (X.isTilesMode = !0),
      (X.numThumbs = R.length),
      _(t),
      1 == X.isTilesMode)
    ) {
      U.setFixedMode(), U.setApproveClickFunction(x), U.init(e, V);
      var n = U.getOptions();
      (X.tileMaxHeight = n.tile_height),
        (X.tileMaxWidth = n.tile_width),
        (Y = U.getObjThumbs());
  ...
  function r() {
    ...
    null != e && d(e.index),
      W.trigger(Q.events.PANE_CHANGE, X.currentPane),
      (X.isFirstTimeRun = !1);
  }
  function o() {
  ...
  function a() {
    ...
    1 == t
      ? ((X.spaceBetweenCols = V.grid_space_between_mobile),
        (X.spaceBetweenRows = V.grid_space_between_mobile))
    ...
    return (
      s < V.grid_min_cols &&
        (a = F.getItemSizeInSpace(
          X.gridWidth,
          V.grid_min_cols,
          X.spaceBetweenCols
        )),
      U.setTileSizeOptions(a),
      a != r && (e = !0),
      e
    );
  }
  function s() {
    var e = o(),
      ...
      n =
        V.grid_num_rows * t +
        (V.grid_num_rows - 1) * X.spaceBetweenRows +
        2 * V.grid_padding;
    (X.gridHeight = n),
      F.setElementSize(G, i, n),
      F.setElementSize(D, i, n),
      (X.innerWidth = i),
      (X.innerHeight = n);
  }
  function l() {
    var e = o(),
      ...
      i =
        V.grid_num_cols * t +
        (V.grid_num_cols - 1) * X.spaceBetweenCols +
        2 * V.grid_padding,
      n = X.gridHeight;
    (X.gridWidth = i),
      F.setElementSize(G, i, n),
  ...
  function _(e) {
    (V = jQuery.extend(V, e)),
      Y.setOptions(e),
      (X.isNavigationVertical =
        "top" == V.grid_panes_direction || "bottom" == V.grid_panes_direction),
      (X.spaceBetweenCols = V.grid_space_between_cols),
      (X.spaceBetweenRows = V.grid_space_between_rows);
  }
  function g() {
    ...
    for (i = 0; i < l; i++) {
      ...
      c > X.innerWidth && (X.innerWidth = c),
        ...
        r++,
        r >= V.grid_num_cols &&
          ((n += _ + X.spaceBetweenRows), (t = o), (r = 0)),
        1 == X.numPanes && X.numThumbsInPane++,
        n + _ > X.gridHeight &&
          ((n = 0),
          (o = X.innerWidth + X.spaceBetweenCols),
          (t = o),
          (r = 0),
          1 == X.isMaxHeight &&
            1 == X.numPanes &&
            ((X.gridHeight = s), G.height(X.gridHeight)),
          i < l - 1 && (X.numPanes++, X.arrPanes.push(o)));
    }
    D.width(X.innerWidth),
      1 == X.isMaxHeight &&
        1 == X.numPanes &&
        ((X.gridHeight = s), G.height(s));
  }
  function c() {
    var e = D.children(".ug-thumb-wrapper"),
      t = 0,
    ...
    for (i = 0; i < l; i++) {
      ...
      g > r && (r = g),
        o++,
        o >= V.grid_num_cols &&
          ((n += _ + X.spaceBetweenRows), (t = a), (o = 0)),
        1 == X.numPanes && X.numThumbsInPane++,
        (g = n + _);
      ...
      g > c &&
        (1 == X.isMaxHeight &&
          1 == X.numPanes &&
          ((X.gridHeight = r), G.height(X.gridHeight), (c = X.gridHeight)),
        (n = c + X.spaceBetweenRows),
        (s = n),
        (a = 0),
        (t = a),
        (o = 0),
        i < l - 1 && (X.numPanes++, X.arrPanes.push(n)));
    }
    D.height(r),
      (X.innerHeight = r),
      1 == X.isMaxHeight &&
        1 == X.numPanes &&
        ((X.gridHeight = r), G.height(r));
  }
  function h() {
    var e = D.children(".ug-thumb-wrapper"),
      t = V.grid_padding,
    ...
    for (i = 0; i < _; i++) {
      ...
      o - t + c > X.gridWidth &&
        ...
        d >= V.grid_num_rows
          ? ((d = 0),
            ...
            (l = 0),
            1 == X.numPanes &&
              ((X.gridWidth = a + V.grid_padding),
              G.width(X.gridWidth),
              (X.gridHeight = u + V.grid_padding),
              G.height(X.gridHeight)),
            X.numPanes++,
            X.arrPanes.push(t - V.grid_padding))
      ...
      var p = a + c;
      p > X.innerWidth && (X.innerWidth = p),
        (o += c + X.spaceBetweenCols),
        1 == X.numPanes && X.numThumbsInPane++;
    }
  ...
  function w(e) {
    var t = {};
    return (
      1 == X.isNavigationVertical ? (t.top = e + "px") : (t.left = e + "px"), t
    );
  }
  function E() {
  ...
  function x() {
    ...
    var e = F.isApproveStoredEventClick(
      X.storedEventID,
      X.isNavigationVertical
    );
    return e;
  ...
  function M(e) {
    ...
    0 == V.grid_carousel && r > 0 && "prev" == o && (r /= 3),
      0 == V.grid_carousel &&
        -a > r &&
        "next" == o &&
  ...
  function O(e) {
    ...
    var i = E(),
      ...
      r = n > 0 ? "prev" : "next";
    "next" == r
      ? 0 == V.grid_carousel && Q.isLastPane()
        ? y()
        : Q.nextPane()
      : 0 == V.grid_carousel && Q.isFirstPane()
      ? y()
      : Q.prevPane();
  }
  function z() {
  ...
  (this.destroy = function () {
    ...
    (this.prevPane = function () {
      var e = X.currentPane - 1;
      return 0 > e && ((e = X.numPanes - 1), 0 == V.grid_carousel)
        ? !1
        : void Q.gotoPane(e, "prev");
    }),
...
function UGTiles() {
  ...
  function n() {
    if (
      ...
      1 == e.tile_enable_image_effect &&
        ...
        $.addClass("ug-tiles-transit-overlays"),
        (_e.isTransActive = !0);
    }
  }
  function r() {
  ...
  function o() {
    return 0 == _e.isTransInited
      ? !1
      : ($.addClass("ug-tiles-transition-active"),
        $.removeClass("ug-tiles-rest-mode"),
        0 == _e.isTransActive ? !1 : void se.disableEvents());
  }
  function a() {
    return 0 == _e.isTransInited
      ? !1
      : ($.removeClass("ug-tiles-transition-active"),
        void $.addClass("ug-tiles-rest-mode"));
  }
  function s() {
    1 == _e.isTransActive
      ? (setTimeout(function () {
  ...
  function l() {
    (ue.colWidth = (ue.availWidth - ue.colGap * (ue.numCols - 1)) / ue.numCols),
      ...
      (ue.totalWidth = ae.getSpaceByNumItems(
        ue.numCols,
        ue.colWidth,
        ue.colGap
      ));
  ...
  function u() {
    if (
      ...
      (ue.numCols = ae.getNumItemsInSpace(
        ue.availWidth,
        ue.colWidth,
        ue.colGap
      )),
  ...
  function c(e) {
    ...
    for (var i = 0; i < t.length; i++) {
      var n = jQuery(t[i]),
        r = void 0;
      1 == de.tiles_keep_order && (r = ae.getColByIndex(ue.numCols, i)),
        g(n, e, !1, r);
    }
    s();
    var a = $.height();
  ...
  function f(e, t) {
    ...
    le.triggerImageLoadedEvent(i, e),
      1 == de.tiles_keep_order
        ? p(i)
        : (se.resizeTile(i, ue.colWidth), g(i, !0, !0));
  }
  function m() {
    ...
    ae.checkImagesLoaded(
      ...
      function () {
        u(),
          (a != ue.numCols || s != ue.galleryWidth) && c(!1),
          n(),
          re.trigger(ne.events.ALL_TILES_LOADED);
      },
      function (e, t) {
        1 == _e.isFirstPlaced && oe.triggerEvent(ne.events.TILES_FIRST_PLACED),
          f(e, t);
      }
    );
  }
  function v() {
    ...
    jQuery.each(t, function (e, t) {
      ...
      var r = le.getItemByThumb(t),
        a = r.thumbWidth,
        s = r.thumbHeight;
      s !== i && (a = Math.floor(r.thumbRatioByWidth * i)),
        (n[e] = a),
        (o += a);
    });
    var l = Math.ceil(o / e);
    ...
    jQuery.each(d, function (t, r) {
      ...
      jQuery.each(_, function (e, t) {
        return 0 == h
          ? !1
          : (0 > h ? ((_[e] = t + 1), h++) : ((_[e] = t - 1), h--),
            void (e == _.length - 1 && 0 != h && (_[e] -= h)));
      }),
        (f[t] = _);
    });
    var b = {
    ...
    jQuery.each(i.arrRows, function (t, n) {
      ...
      jQuery.each(n, function (t, n) {
        var u = jQuery(n),
          d = o,
          _ = r[t];
        se.resizeTile(u, _, d, se.resizemode.VISIBLE_ELEMENTS),
          ae.placeElement(u, s, a),
          (s += _),
          s > l && (l = s),
          (s += i.gap),
          1 == e && jQuery(n).show();
      ...
      ae.checkImagesLoaded(
        ...
        function () {
          setTimeout(function () {
            b(!0),
              t.fadeTo(0, 1),
              oe.triggerEvent(ne.events.TILES_FIRST_PLACED),
              n(),
              re.trigger(ne.events.ALL_TILES_LOADED);
          });
        },
  ...
  function T(e) {
    var t,
      ...
      s = e.index(),
      l = Math.ceil(
        S(s) * ((1 * ge.nestedOptimalCols) / 3) + (2 * ge.nestedOptimalCols) / 3
      ),
      u = a.width,
      d = a.height,
      _ = u / d;
    return (
      u > d
        ? ((t = l), (i = Math.round(t / _)), 0 == i && (i = 1))
        : ((i = l), (t = Math.round(i * _)), 0 == t && (t = 1)),
      (n.dimWidth = t),
      (n.dimHeight = i),
      (n.width = t * r + o * (t - 1)),
      (n.height = i * r + o * (i - 1)),
  ...
  function x(e) {
    if (1 == de.tiles_nested_debug)
      return "undefined" == typeof e && (e = !0), P(!0, e), !1;
  ...
  function C(e, t, i) {
    ...
    if (
      ...
      var _ = z(l, d.dimWidth, i),
        ...
        c = !1;
      g >= 2 && (c = !0),
        u.newHeight >= n.dimHeight && (n = k(e, u.newHeight, !0));
  ...
  function A(e) {
    for (var t = 0, i = 0, n = 0; n < e.length - 1; n++) {
      ...
      Q(r.top + r.dimHeight) &&
        ...
        ((o = te[r.top + r.dimHeight - 1][r.left + r.dimWidth]),
        (a = te[r.top + r.dimHeight][r.left + r.dimWidth])),
        o != a && t++;
    }
    for (var n = 0; n < e.length - 1; n++) {
      ...
      Q(r.top + r.dimHeight) &&
        r.left - 1 >= 0 &&
        ((o = te[r.top + r.dimHeight - 1][r.left - 1]),
        (a = te[r.top + r.dimHeight][r.left - 1])),
        o != a && i++;
    }
    return Math.max(i, t);
  }
  function M(e, t, i) {
    var n = ie[e],
      ...
      s =
        ...
        parseInt(o / (ge.colWidth + ge.currentGap)),
        r - t + i),
      l = k(e, s, !0),
      u = [];
  ...
  function H(e, t) {
    ...
    if (
      ...
      for (var u = 0; ; ) {
        if (
          "undefined" == typeof te[ge.gridY + u] ||
          -1 == te[ge.gridY + u][e - 1]
        )
          break;
  ...
  function N(e, t, i) {
    ...
    (o.dimWidth = dimWidth),
      (o.dimHeight = dimHeight),
      (o.width = dimWidth * n + r * (dimWidth - 1)),
      (o.height = dimHeight * n + r * (dimHeight - 1));
  }
  function k(e, t, i) {
    i || (i = !1);
    var n = ie[e],
  ...
  function V(e, t) {
    ...
    se.resizeTile(i, n.width, n.height, se.resizemode.VISIBLE_ELEMENTS),
      ae.placeElement(i, o, r),
  ...
  function q() {
    switch (
      (J.children(".ug-tile").show(),
      1 == _e.isFirstTimeRun && Z(),
      se.run(),
      de.tiles_type)
    ) {
      default:
...
function UGTileDesign() {
  function e(e, i) {
    ...
    var s = W.getOptions();
    (B = jQuery.extend(B, s)),
      (Y.ratioByWidth = B.tile_width / B.tile_height),
      (Y.ratioByHeight = B.tile_height / B.tile_width),
      B.tile_size_by == R.sizeby.GLOBAL_RATIO &&
        Y.isTextpanelOutside &&
        (Y.hasImageContainer = !0);
  }
  function t() {
    if (
      (1 == B.tile_enable_overlay
        ? ((B.thumb_overlay_opacity = B.tile_overlay_opacity),
          (B.thumb_overlay_color = B.tile_overlay_color))
        : 0 == B.tile_enable_icons
        ? (B.thumb_color_overlay_effect = !1)
        : (B.thumb_overlay_opacity = 0),
      B.tile_as_link &&
        ((B.thumb_wrapper_as_link = !0),
        (B.thumb_link_newpage = B.tile_link_newpage)),
      1 == B.tile_enable_outline &&
        0 == B.tile_enable_border &&
        (B.tile_enable_outline = !1),
      (Y.tileInnerReduce = 0),
      B.tile_enable_border &&
        ((Y.tileInnerReduce = 2 * B.tile_border_width),
      ...
      switch (B.tile_textpanel_position) {
        ...
        case "bottom":
          (Y.isTextpanelOutside = !0),
            (B.tile_textpanel_always_on = !0),
            (B.tile_textpanel_offset = 0);
          break;
        case "inside_top":
          B.tile_textpanel_align = "top";
          break;
        case "middle":
          (B.tile_textpanel_align = "middle"),
            (B.tile_textpanel_appear_type = "fade");
      }
      0 == B.tile_textpanel_always_on && (Y.isSaparateIcons = !0);
    }
    0 != B.tile_textpanel_offset &&
      ((B.tile_textpanel_appear_type = "fade"),
      (B.tile_textpanel_margin = B.tile_textpanel_offset)),
      "title_and_desc" == B.tile_textpanel_source &&
        ((B.tile_textpanel_enable_description = !0),
  ...
  function i() {
    ...
    switch (
      ...
      1 == e && 0 == B.tile_textpanel_always_on && (Y.isTextPanelHidden = !0),
      (Y.isVideoplayIconAlwaysOn = B.tile_videoplay_icon_always_on),
  ...
  function n(e, t) {
    ...
    (0 == B.tile_enable_image_effect || 1 == B.tile_image_effect_reverse) &&
      (n += " ug-trans-enabled");
    var r = Q.stripTags(t.title);
    (r = Q.htmlentitles(r)),
      (i +=
        '<img src="' +
        Q.escapeDoubleSlash(t.urlThumb) +
        "\" alt='" +
        r +
        "' class='" +
        n +
    ...
    var o = {};
    if (
      (1 == B.tile_enable_background &&
        (o["background-color"] = B.tile_background_color),
      1 == B.tile_enable_border &&
        ((o["border-width"] = B.tile_border_width + "px"),
        (o["border-style"] = "solid"),
        (o["border-color"] = B.tile_border_color),
        B.tile_border_radius &&
          (o["border-radius"] = B.tile_border_radius + "px")),
      1 == B.tile_enable_outline &&
        (o.outline = "1px solid " + B.tile_outline_color),
      1 == B.tile_enable_shadow)
    ) {
      var a = B.tile_shadow_h + "px ";
      (a += B.tile_shadow_v + "px "),
        (a += B.tile_shadow_blur + "px "),
        (a += B.tile_shadow_spread + "px "),
        (a += B.tile_shadow_color),
        (o["box-shadow"] = a);
    }
    e.css(o);
    var s = "";
    if (B.tile_enable_icons) {
      ...
      if ((t.link && 1 == B.tile_show_link_icon) || 1 == B.tile_as_link)
        if (0 == B.tile_as_link) {
          var u = "";
          1 == B.tile_link_newpage && (u = " target='_blank'"),
            (s +=
              "<a href='" +
              t.link +
              "'" +
      ...
      0 == h.length ? (h = null) : h.hide(),
        h || 1 != B.tile_enable_action || e.addClass("ug-tile-clickable");
    ...
    if (1 == B.tile_enable_textpanel) {
      ...
      v.init(D, B, "tile");
      var b = "";
      (1 == B.tile_textpanel_always_on || 1 == Y.isTextpanelOutside) &&
        (b = "ug-trans-enabled"),
        v.appendHTML(e, b);
      var y = t.title,
        I = "";
      ...
      if (
        (v.setTextPlain(y, I),
        0 == B.tile_textpanel_always_on && v.getElement().fadeTo(0, 0),
        e.data("objTextPanel", v),
        1 == B.tile_textpanel_always_on)
      ) {
        var w = d(e);
        w.css("z-index", 2);
      }
  ...
  function b(e, t, i, n) {
    ...
    if (1 == Y.isTextpanelOutside) {
      ...
      if (
        ((i -= _),
        "top" == B.tile_textpanel_position && (d = _),
        1 == Y.hasImageContainer)
      ) {
        var c = a(e);
    ...
    if (0 == B.tile_enable_image_effect)
      Q.scaleImageCoverParent(l, t, i),
        0 == Y.hasImageContainer && null !== d && Q.placeElement(l, 0, d);
    else {
      var h = "nothing";
      n === !0 &&
        0 == Y.isTextpanelOutside &&
        (h = 1 == B.tile_image_effect_reverse ? "effect" : "image"),
        "effect" != h &&
          (Q.setElementSize(o, t, i),
          null !== d && Q.placeElement(o, 0, d),
          Q.scaleImageCoverParent(u, t, i)),
        "image" != h &&
          (1 == Y.hasImageContainer
            ? Q.scaleImageCoverParent(l, t, i)
            : "effect" == h
            ? (Q.scaleImageCoverParent(l, t, i),
              null !== d && Q.placeElement(l, 0, d))
            : Q.cloneElementSizeAndPos(u, l, !1, null, d));
    }
  }
  function y(e, t, i, n) {
    var r = null;
    ...
    var _ =
      1 == B.tile_textpanel_always_on || "fade" == B.tile_textpanel_appear_type;
    if (_)
      if (
        1 == Y.isTextpanelOutside &&
        n &&
        "bottom" == B.tile_textpanel_position
      ) {
        var c = n - d;
        s.positionPanel(c);
  ...
  function I(e) {
    ...
    b(e, n.width, n.height),
      1 == B.tile_enable_textpanel && y(e, "regular", n.width, n.height);
    ...
    if (t && i) {
      ...
      I > E &&
        ((I = Math.floor((n.width - m.width - v.width) / 3)),
        (w = m.width + I + v.width),
        (E = Math.floor((n.width - w) / 2))),
        Q.placeElement(t, E, "middle", 0, _),
        Q.placeElement(i, E + m.width + I, "middle", 0, _);
    } else
      t && Q.placeElement(t, "center", "middle", 0, _),
        i && Q.placeElement(i, "center", "middle", 0, _);
    t && t.show(), i && i.show();
  }
  function w(e, t) {
  ...
  function E(e, t) {
    ...
    if ("slide" == B.tile_textpanel_appear_type) {
      ...
      var o = -r.height,
        ...
        l = {},
        u = "bottom";
      "inside_top" == B.tile_textpanel_position && (u = "top"),
        (s[u] = o + "px"),
        (l[u] = a + "px"),
        1 == t
          ? (n.fadeTo(0, 1),
            0 == n.is(":animated") && n.css(s),
            (l.opacity = 1),
            n.stop(!0).animate(l, i))
          : n.stop(!0).animate(s, i);
  ...
  function S(e, t) {
    if (
      ((t = jQuery(t)),
      B.tile_enable_image_effect && w(t, !0),
      1 == B.tile_enable_textpanel &&
        0 == B.tile_textpanel_always_on &&
        0 == Y.isTextPanelHidden &&
        E(t, !0),
      Y.isSaparateIcons && 1 == B.tile_enable_icons)
    ) {
  ...
  function P(e, t) {
    if (
      ((t = jQuery(t)),
      B.tile_enable_image_effect && w(t, !1),
      1 == B.tile_enable_textpanel &&
        0 == B.tile_textpanel_always_on &&
        E(t, !1),
      1 == Y.isSaparateIcons && 1 == B.tile_enable_icons)
    ) {
  ...
  function j(e, t, i) {
    return (
      (t = jQuery(t)),
      1 == B.tile_visible_before_image &&
      t.data("image_placed") !== !0 &&
      i !== !0
        ? !0
        : (I(t), void W.setThumbNormalStyle(t))
    );
  }
  function C(e, t, i) {
  ...
  function A(e) {
    return 1 == m(e)
      ? (G.trigger(R.events.TILE_CLICK, e), !0)
      : void (0 == f(e) && (x(e), W.setThumbOverStyle(e)));
  }
  function M(e) {
    var t = jQuery(this),
  ...
  function O(e) {
    ...
    return (
      ...
      0 == f(t)
        ? (A(t), !0)
        : 1 == i
        ? (G.trigger(R.events.TILE_CLICK, t), !1)
        : void 0
    );
  }
  function z(e) {
    ...
    Y.funcParentApproveClick &&
      ...
      e.preventDefault(),
      0 == f(t) && 0 == B.tile_as_link && (e.preventDefault(), A(t));
  }
  var L,
    H,
    N,
  ...
  (this.loadTileImage = function (e) {
    ...
    (this.setTileSizeOptions = function (e) {
      if (B.tile_size_by !== R.sizeby.GLOBAL_RATIO)
    ...
    (this.run = function (e) {
      ...
      var i = W.getThumbs(t);
      B.tile_size_by == R.sizeby.GLOBAL_RATIO &&
        R.resizeAllTiles(B.tile_width, R.resizemode.WRAPPER_ONLY, i),
        1 == B.tile_enable_image_effect &&
          0 == B.tile_image_effect_reverse &&
    ...
    (this.getTileHeightByWidth = function (e, t) {
      ...
      return (
        t &&
          1 == Y.isTextpanelOutside &&
          B.tile_size_by == R.sizeby.IMAGE_RATIO &&
          (n += g(t)),
        n
      );
    }),
...
function UGAviaControl() {
  ...
  function l(e) {
    ...
    return null === t
      ? !1
      : ((f.is_strip_moving = !0), (f.strip_finalPos = t), void o());
  }
  var u,
    d,
    _,
...
function UGSlider() {
  function e(e, t, n) {
    (me = e),
      n && ((he = n), (t = we.convertCustomPrefixOptions(t, he, "slider"))),
      (te = jQuery(e));
    var r = me.getObjects();
    if (
      ((ie = r.g_objWrapper),
      ...
      t.hasOwnProperty("slider_progress_indicator_type") &&
        (Se.slider_progress_indicator_type = t.slider_progress_indicator_type),
      "bar" == Se.slider_progress_indicator_type &&
        (Se = jQuery.extend(Se, Pe)),
      t && pe.setOptions(t),
      i(),
    ...
    Se.slider_enable_text_panel &&
      ((Te = new UGTextPanel()), Te.init(me, Se, "slider")),
      Se.slider_enable_zoom_panel &&
        ((ce = new UGZoomButtonsPanel()), ce.init(pe, Se));
  ...
  function t() {
    ...
    if (((xe.isRunOnce = !0), Se.slider_background_color)) {
      ...
      1 != Se.slider_background_opacity &&
        (e = we.convertHexToRGB(e, Se.slider_background_opacity)),
        re.css("background-color", e);
    } else
      1 != Se.slider_background_opacity &&
        ((e = we.convertHexToRGB("#000000", Se.slider_background_opacity)),
        re.css("background-color", e));
    1 == Se.slider_control_swipe &&
      ((_e = new UGTouchSliderControl()), _e.init(pe, Se)),
      1 == Se.slider_control_zoom &&
        ((ge = new UGZoomSliderControl()), ge.init(pe, Se)),
      Te && Te.run(),
      X();
  }
  function i() {
    ...
    "" == Se.slider_bullets_skin && (Se.slider_bullets_skin = t),
      ...
      "" == Se.slider_fullscreen_button_skin &&
        (Se.slider_fullscreen_button_skin = t),
    ...
    if (
      ...
      1 == Se.slider_enable_arrows &&
        ((i +=
          ...
          Se.slider_arrows_skin +
          "'></div>"),
        (i +=
          "<div class='ug-slider-control ug-arrow-right ug-skin-" +
          Se.slider_arrows_skin +
          "'></div>")),
      1 == Se.slider_enable_play_button &&
        (i +=
          "<div class='ug-slider-control ug-button-play ug-skin-" +
          Se.slider_play_button_skin +
          "'></div>"),
      1 == Se.slider_enable_fullscreen_button &&
        (i +=
      ...
      var r = Ee.getType();
      "bar" == r &&
        "pie" == Se.slider_progress_indicator_type &&
        ((Se.slider_progress_indicator_type = "bar"),
        (Se = jQuery.extend(Se, Pe))),
        me.setProgressIndicator(Ee);
    }
    if (
      1 == Se.slider_enable_text_panel &&
      (Te.appendHTML(re), 0 == Se.slider_textpanel_always_on)
    ) {
      var o = Te.getElement();
  ...
  function a() {
    if (
      (ye &&
        ...
        we.placeElement(
          objBullets,
          Se.slider_bullets_align_hor,
          Se.slider_bullets_align_vert,
          Se.slider_bullets_offset_hor,
          Se.slider_bullets_offset_vert
        ),
        we.placeElement(
          objBullets,
          Se.slider_bullets_align_hor,
      ...
      1 == Se.slider_enable_arrows &&
        (we.placeElement(
          ue,
          Se.slider_arrow_left_align_hor,
          Se.slider_arrow_left_align_vert,
          Se.slider_arrow_left_offset_hor,
          Se.slider_arrow_left_offset_vert
        ),
        we.placeElement(
          de,
          Se.slider_arrow_right_align_hor,
          Se.slider_arrow_left_align_vert,
          Se.slider_arrow_right_offset_hor,
          Se.slider_arrow_right_offset_vert
        )),
      ...
      if ("bar" == Se.slider_progress_indicator_type) {
        ...
        Ee.setSize(t),
          we.placeElement(
            e,
            "left",
            Se.slider_progress_indicator_align_vert,
            0,
        ...
        we.placeElement(
          e,
          Se.slider_progress_indicator_align_hor,
          Se.slider_progress_indicator_align_vert,
          Se.slider_progress_indicator_offset_hor,
          Se.slider_progress_indicator_offset_vert
        );
    }
  ...
  function s() {
    if (
      (ve &&
        we.placeElement(
          ve,
          Se.slider_play_button_align_hor,
          Se.slider_play_button_align_vert,
          Se.slider_play_button_offset_hor,
          Se.slider_play_button_offset_vert
        ),
      be &&
        we.placeElement(
          be,
          Se.slider_fullscreen_button_align_hor,
          Se.slider_fullscreen_button_align_vert,
          Se.slider_fullscreen_button_offset_hor,
          Se.slider_fullscreen_button_offset_vert
        ),
      ce)
    ) {
      var e = ce.getElement();
      we.placeElement(
        e,
        Se.slider_zoompanel_align_hor,
        Se.slider_zoompanel_align_vert,
        Se.slider_zoompanel_offset_hor,
        Se.slider_zoompanel_offset_vert
      );
    }
  }
  function l() {
    ...
    (i = pe.isSlideHasItem(r.objNextSlide)),
      ...
      n
        ? ((s = r.objPrevSlide.outerWidth()), r.objPrevSlide.css("z-index", 1))
        : r.objPrevSlide.hide(),
      ...
      n &&
        (we.placeElement(r.objPrevSlide, a, o), we.showElement(r.objPrevSlide)),
      i &&
        (we.showElement(r.objNextSlide), we.placeElement(r.objNextSlide, t, o));
  }
  function u(e) {
    var t = e.data("index");
  ...
  function g(e, t) {
    ...
    if (
      (t &&
        ...
        t.hasOwnProperty("imageHeight") && (o = t.imageHeight)),
      0 >= r)
    )
      return i;
    var a = o > r ? r : o,
  ...
  function c(e, t, i) {
    ...
    if (1 == Se.slider_image_border) {
      ...
      var r = g(e, i);
      (n["border-width"] = r + "px"),
        (n["border-color"] = Se.slider_image_border_color),
        (n["border-radius"] = Se.slider_image_border_radius);
    }
    "image" != t &&
      1 == Se.slider_video_constantsize &&
      (n["background-color"] = "#000000"),
      1 == Se.slider_image_shadow &&
  ...
  function h(e, t) {
    var i = Se.slider_video_constantsize_width,
      ...
      o = we.scaleImageExactSizeInParent(
        e,
        t.imageWidth,
        t.imageHeight,
        i,
  ...
  function p(e, t, i) {
    ...
    if (((objPadding = pe.getObjImagePadding()), a == o && i !== !0)) {
      ...
      var g = {};
      (g =
        "image" != l && 1 == Se.slider_video_constantsize
          ? h(u, t)
          : we.scaleImageFitParent(
              u,
              t.imageWidth,
              t.imageHeight,
              s,
        ...
        c(u, l, g),
        fe.trigger(pe.events.AFTER_PUT_IMAGE, e);
    } else if (
      ((u = we.placeImageInsideParent(
        o,
        n,
        t.imageWidth,
        t.imageHeight,
      ...
      if (
        ...
        var g = we.getImageInsideParentData(
          n,
          t.imageWidth,
          t.imageHeight,
          s,
      ...
      u.fadeTo(0, 0),
        ...
        u.on("load", function () {
          ...
          _(r),
            i.data("isLoading", !1),
            pe.isSlideCurrent(i) && fe.trigger(pe.events.CURRENTSLIDE_LOAD_END),
            me.onItemBigImageLoaded(null, e);
          var s = me.getItem(t),
            l = {};
          "image" != n && 1 == Se.slider_video_constantsize
            ? h(e, s)
            : (l = we.scaleImageFitParent(
                e,
                s.imageWidth,
                s.imageHeight,
                a,
            ...
            e.fadeTo(0, 1),
            c(e, n, l),
            fe.trigger(pe.events.AFTER_PUT_IMAGE, i);
        });
  }
  function f(e, t) {
    try {
      ...
      throw (
        ("undefined" != typeof r.fileName &&
          "showbig" == r.fileName &&
          me.showErrorMessageReplaceGallery(r.message),
        i.html(""),
        new Error(r))
      );
    }
  ...
  function m() {
    ...
    var e = Te.getElement(),
      t = 0;
    (1 == xe.isTextPanelSaparateHover || 1 == Se.slider_textpanel_always_on) &&
      (t = Se.slider_controls_appear_duration),
      e.stop().fadeTo(t, 0),
      e.data("isHidden", !0);
  }
  function v() {
  ...
  function S(e, t, i) {
    i
      ? e.fadeTo(Se.slider_transition_speed, t, i)
      : e.fadeTo(Se.slider_transition_speed, t);
  }
  function P(e, t, i) {
    if (!t) var t = !1;
    var n = pe.getSlidesReference();
    ...
    if (
      ...
      n.objCurrentSlide.fadeTo(0, 0),
        ...
        pe.placeNabourItems(),
        fe.trigger(pe.events.TRANSITION_END),
        i !== !0 && Ie.hide();
    else {
      if (
  ...
  function x() {
    1 == Se.slider_fullscreen_button_mobilehide && be && be.hide(),
      1 == Se.slider_play_button_mobilehide && ve && ve.hide(),
      1 == Se.slider_zoompanel_mobilehide && ce && ce.getElement().hide();
  }
  function j() {
    1 == Se.slider_fullscreen_button_mobilehide && be && be.show(),
      1 == Se.slider_play_button_mobilehide && ve && ve.show(),
      1 == Se.slider_zoompanel_mobilehide && ce && ce.getElement().show();
  }
  function C() {
  ...
  function O(e) {
    ...
    e === !0
      ...
      : (t.stop().show().fadeTo(0, 0),
        t.fadeTo(Se.slider_controls_appear_duration, 1)),
      (xe.isControlsVisible = !0);
  }
  function z() {
  ...
  function H(e, t, i) {
    ...
    var r = n.index;
    ye && ye.setActive(r),
      Te && 0 == xe.isTextPanelSaparateHover && v(),
      L("image" == n.type ? "image" : "video");
  }
  function N(e, t) {
    me.selectItem(t);
  }
  function k(e) {
    return _e && 0 == _e.isTapEventOccured(e)
      ? !0
      : void fe.trigger(pe.events.CLICK, e);
  }
  function R() {
    var e = pe.getCurrentSlide(),
    ...
    return t
      ...
      : void (
          ...
          (z(),
          Te &&
            1 == Se.slider_textpanel_always_on &&
            pe.isCurrentSlideType("image") &&
            pe.isCurrentSlideImageFit() &&
            v())
        );
  }
  function G(e) {
  ...
  function Y(e, t, i) {
    ae.data("index") == t && ((objItem = me.getItem(t)), p(ae, objItem, !0)),
      se.data("index") == t && ((objItem = me.getItem(t)), p(se, objItem, !0)),
      le.data("index") == t && ((objItem = me.getItem(t)), p(le, objItem, !0));
  }
  function U(e, t) {
    t = jQuery(t);
  ...
  function X() {
    te.on(me.events.ITEM_IMAGE_UPDATED, Y),
      ...
      1 == Se.slider_enable_arrows &&
        (we.addClassOnHover(de, "ug-arrow-hover"),
        we.addClassOnHover(ue, "ug-arrow-hover"),
        me.setNextButton(de),
        me.setPrevButton(ue)),
      ...
      be &&
        (we.addClassOnHover(be, "ug-button-hover"),
        me.setFullScreenToggleButton(be)),
  ...
  (this.switchSlideNums = function (e) {
    switch ((fe.trigger(pe.events.BEFORE_SWITCH_SLIDES), e)) {
      case "left":
        var t = xe.numCurrent;
        (xe.numCurrent = xe.numNext),
          (xe.numNext = xe.numPrev),
          (xe.numPrev = t);
        break;
      case "right":
        var t = xe.numCurrent;
        (xe.numCurrent = xe.numPrev),
          (xe.numPrev = xe.numNext),
          (xe.numNext = t);
        break;
      default:
        throw new Error("wrong direction: " + e);
    ...
    (this.startSlideAction = function (e) {
      ...
      switch (
        (1 == Se.slider_video_constantsize && w(), I(), Ie.show(), t.type)
      ) {
        case "youtube":
    ...
    (this.getScaleMode = function (e) {
      ...
      return "image" != t
        ? Se.slider_scale_mode_media
        : Se.slider_scale_mode == Se.slider_scale_mode_fullscreen
        ? Se.slider_scale_mode
        : 1 == me.isFullScreen()
        ? Se.slider_scale_mode_fullscreen
        : Se.slider_scale_mode;
    }),
    (this.getObjects = function () {
      var e = {
    ...
    (this.setOptions = function (e) {
      he && (e = we.convertCustomPrefixOptions(e, he, "slider")),
        (Se = jQuery.extend(Se, e));
    }),
    (this.setSize = function (e, t) {
      ...
      if ("image" != _ && 1 == Se.slider_video_constantsize) w();
        ...
        var g =
            e - Se.slider_video_padding_left - Se.slider_video_padding_right,
...
function UGTextPanel() {
  ...
  (this.positionElements = function (t) {
    ...
    (this.init = function (e, t, i) {
      if (
        ((h = e),
        i && ((m = i), (t = f.convertCustomPrefixOptions(t, m, "textpanel"))),
    ...
    (this.setPanelSize = function (e, t) {
      ...
      f.setElementSizeAndPosition(c, n, 0, i, t),
        d && d.width(i),
        _ && _.width(i),
        0 == b.isFirstTime && p.positionElements(!1);
    }),
    ...
    (this.setOptions = function (e) {
      m && (e = f.convertCustomPrefixOptions(e, m, "textpanel")),
        (v = jQuery.extend(v, e));
    }),
    (this.getElement = function () {
      return l;
    ...
    (this.refresh = function (e, t, i, n) {
      o(),
        i ? p.setPanelSize(i, n) : p.setSizeByParent(),
        p.positionElements(!1),
        t !== !0 && p.positionPanel(),
        e === !0 && p.show();
    }),
    (this.hide = function () {
  ...
  (this.init = function (e, t) {
    ...
    (this.setObjects = function (e, t, i) {
      (a = e),
        (s = t),
        (l = i),
        s && s.addClass("ug-zoompanel-button-disabled"),
...
function UGProgressPie() {
  function e(e) {
    if (!e) var e = 0;
    var t =
        Math.min(a.slider_progresspie_width, a.slider_progresspie_height) / 2,
      n = i[0].getContext("2d");
    0 == r && ((r = !0), n.rotate(1.5 * Math.PI), n.translate(-2 * t, 0)),
      n.clearRect(
        0,
        0,
        a.slider_progresspie_width,
        a.slider_progresspie_height
      );
    ...
    1 == a.slider_progresspie_type_fill &&
      ((l = u),
      (u = 2 * Math.PI),
      n.beginPath(),
      n.arc(o, s, t, l, u),
      n.lineTo(o, s),
      (n.fillStyle = a.slider_progresspie_color2),
      n.fill(),
      n.closePath());
  }
  var t,
...
function UGTouchSliderControl() {
  ...
  function o(e) {
    ...
    if (
      (0 == b.isDragging &&
        ((b.isDragging = !0), p.trigger(m.events.START_DRAG)),
      h.css("left", o + "px"),
      1 == b.isDragVideo)
    ) {
      var u = o - b.startPosx,
  ...
  function u(e) {
    e.preventDefault(),
      (b.isDragging = !1),
      1 == m.isAnimating() && h.stop(!0, !0);
    var t = v.getArrTouches(e);
    return t.length > 1
      ? (1 == b.touch_active && s("1"), !0)
      : 1 == b.touch_active
      ? !0
      : void l("1", e);
  }
  ...
  function g() {
    c.bind("mousedown touchstart", u),
      jQuery("body").bind("mousemove touchmove", d),
      jQuery(window).add("body").bind("mouseup touchend", _);
  }
  var c,
    h,
    p,
...
function UGZoomSliderControl() {
  ...
  function i() {
    ...
    if (
      ((P.objSlide = n.objCurrentSlide),
      (P.objImage = n.objCurrentSlide.find("img")),
      0 == P.objImage.length)
    )
      return !1;
    (P.objImageSize = T.getElementSize(P.objImage)),
      (P.objParent = P.objImage.parent()),
      (P.objParentSize = T.getElementSize(P.objParent));
    var r = t();
    (objPadding = E.getObjImagePadding()),
      (P.objFitImageSize = T.getImageInsideParentDataByImage(
        P.objImage,
        r,
        objPadding
      ));
  ...
  function n(e, i) {
    ...
    if ("back" == e) {
      ...
      var u = "in" == e ? !0 : !1;
      a = T.zoomImageInsideParent(
        r,
        u,
        S.slider_zoom_step,
        i,
        o,
        S.slider_zoom_max_ratio,
        s
      );
    }
    1 == a &&
      (w.trigger(E.events.ZOOMING),
      w.trigger(E.events.ZOOM_CHANGE),
      w.trigger(E.events.ZOOM_END));
  }
  function r(e, t, i) {
  ...
  function s(e) {
    ...
    var t = T.getMousePosition(e),
      i =
        (t.pageX - P.startMouseX,
        t.pageY - P.startMouseY,
        t.pageX - P.lastMouseX),
    ...
    0 == P.panYActive
      ...
      : "down" == o && a.top > 0
      ? (n /= 3)
      : "up" == o && a.bottom < P.objParentSize.height && (n /= 3),
      0 == P.panXActive || 0 == E.isInnerInPlace()
        ? (i = 0)
        : "right" == r && a.left > 0
        ? (i /= 3)
        : "left" == r && a.right < P.objParentSize.width && (i /= 3);
    var s = a.left + i,
      l = a.top + n;
  ...
  function l() {
    ...
    (P.panXActive = P.objImageSize.width > P.objParentSize.width),
      ...
      1 == P.panYActive
        ? r.top > 0
          ? ((n = 0), (t = !0))
          : r.bottom < P.objParentSize.height &&
            ((n = P.objParentSize.height - r.height), (t = !0))
        : r.top != a.top && ((t = !0), (n = a.top)),
      1 == P.panXActive
        ? r.left > 0
          ? ((i = 0), (e = !0))
          : r.right < P.objParentSize.width &&
            ((i = P.objParentSize.width - r.width), (e = !0))
        : r.left != a.left && ((e = !0), (i = a.left));
    var s = {};
    1 == t && (s.top = n + "px"),
      1 == e && (s.left = i + "px"),
      (1 == t || 1 == e) &&
        P.objImage.animate(s, {
  ...
  function d(e) {
    (P.isZoomActive = !0),
      ...
      (P.startMiddlePoint = T.getMiddlePoint(
        e[0].pageX,
        e[0].pageY,
        e[1].pageX,
        e[1].pageY
      ...
      (P.startImageX = P.objImageSize.left),
      (P.startImageY = P.objImageSize.top),
      (P.imageOrientPoint = T.getElementLocalPoint(
        P.startMiddlePoint,
        P.objImage
      ));
    var t = T.isPointInsideElement(P.imageOrientPoint, P.objImageSize);
    0 == t && (P.imageOrientPoint = T.getElementCenterPoint(P.objImage)),
      w.trigger(E.events.ZOOM_START);
  }
  function _(e) {
  ...
  function c(e) {
    ...
    if ((s.width > 0 && (l = o / s.width), l > S.slider_zoom_max_ratio))
      return !0;
    (panX = -(P.imageOrientPoint.x * n - P.imageOrientPoint.x)),
      (panY = -(P.imageOrientPoint.y * n - P.imageOrientPoint.y));
    var u = r.x - P.startMiddlePoint.x,
      d = r.y - P.startMiddlePoint.y,
      _ = P.startImageX + panX + u,
      g = P.startImageY + panY + d;
    T.setElementSizeAndPosition(P.objImage, _, g, o, a),
      w.trigger(E.events.ZOOMING),
      w.trigger(E.events.ZOOM_CHANGE);
  }
  function h() {
  ...
  function p(e) {
    ...
    return void 0 == P.objImage || 0 == P.objImage.length
      ? !0
      : (e.preventDefault(),
        1 == u() && P.objImage.stop(!0),
        1 == P.isZoomActive ? _(e) : g(e),
        void (1 == P.isZoomActive
          ? (P.isPanActive = !1)
          : 1 == r(P.objImage, e) && 1 == P.isZoomedOnce && a(e)));
  }
  function f(e) {
    if (0 == E.isCurrentSlideType("image")) return !0;
  ...
  function m(e) {
    return 0 == E.isCurrentSlideType("image")
      ? !0
      : void (1 == P.isZoomActive ? c(e) : 1 == P.isPanActive && s(e));
  }
  function v(e, t, i, r) {
  ...
  function b() {
    y.on("mousewheel", v),
      y.bind("mousedown touchstart", p),
      jQuery("body").bind("mousemove touchmove", m),
      jQuery(window).add("body").bind("mouseup touchend", f),
      w.bind(E.events.BEFORE_RETURN, function () {
        h();
      }),
...
function UGWistiaAPI() {
  ...
  (this.events = {
    ...
    (this.loadAPI = function () {
      return 1 == g_ugWistiaAPI.isAPILoaded
        ? !0
        : e()
        ? ((g_ugWistiaAPI.isAPILoaded = !0), !0)
        : (g_ugFunctions.loadJs("fast.wistia.com/assets/external/E-v1.js", !0),
...
function UGSoundCloudAPI() {
  ...
  (this.events = {
    ...
    (this.loadAPI = function () {
      return 1 == g_ugSoundCloudAPI.isAPILoaded
        ? !0
        : e()
...
function UGVimeoAPI() {
  ...
  (this.events = {
    ...
    (this.loadAPI = function () {
      return 1 == g_ugVimeoAPI.isAPILoaded
        ? !0
        : e()
    ...
    (this.changeVideo = function (e, t) {
      return 0 == o.isPlayerReady()
        ? !1
        : ((u = t), void s.api("loadVideo", e));
    }),
...
function UGYoutubeAPI() {
  ...
  (this.events = {
    ...
    (this.loadAPI = function () {
      return 1 == g_ugYoutubeAPI.isAPILoaded
        ? !0
        : "undefined" != typeof YT
    ...
    (this.changeVideo = function (e, t) {
      return 0 == a.isPlayerReady()
        ? !1
        : void (t && 1 == t
            ? s.loadVideoById(e, 0, "large")
            : s.cueVideoById(e, 0, "large"));
    }),
    (this.isPlayerReady = function () {
      return l && s ? !0 : !1;
    }),
  ...
  (this.init = function (e, t, i) {
    ...
    (this.setHtml = function (e) {
      ...
      (t +=
        ...
        0 == T.standAloneMode &&
          1 == E.video_enable_closebutton &&
          (_ = s.children(".ug-videoplayer-button-close"));
    }),
    (this.destroy = function () {
    ...
    (this.show = function () {
      return 1 == h.isVisible()
        ? !0
        : (s.show(),
          s.fadeTo(0, 1),
          _ && _.show(),
          void p.trigger(h.events.SHOW));
    }),
    (this.hide = function () {
      return 0 == h.isVisible()
        ? !0
        : (o(), (w = null), s.hide(), void p.trigger(h.events.HIDE));
    }),
    ...
    (this.playYoutube = function (e, t) {
      ...
      0 == i.length && l.append("<div id='" + T.youtubeInnerID + "'></div>"),
        1 == m.isPlayerReady() && 1 == T.standAloneMode
          ? m.changeVideo(e, t)
          : m.putVideo(T.youtubeInnerID, e, "100%", "100%", t),
        (w = "youtube");
    }),
    (this.playVimeo = function (e, t) {
      ...
      o("vimeo"),
        u.show(),
        v.putVideo(T.vimeoPlayerID, e, "100%", "100%", t),
        (w = "vimeo");
    }),
    ...
    (this.playSoundCloud = function (e, t) {
      ...
      o("soundcloud"),
        g.show(),
        y.putSound(T.soundCloudPlayerID, e, "100%", "100%", t),
        (w = "soundcloud");
    }),
    (this.playWistia = function (e, t) {
      ...
      o("wistia"),
        c.show(),
        I.putVideo(T.wistiaPlayerID, e, "100%", "100%", t),
        (w = "wistia");
    });
}
...
function UniteGalleryMain() {
  ...
  function fillItemByChild(e) {
    ...
    if (((a.type = o), "img" == n)) {
      ...
      l || (l = d),
        ...
        (a.title = e.attr("alt")),
        (a.objThumbImage = e),
        a.objThumbImage.attr("src", a.urlThumb);
    } else {
      if ("image" == o)
        throw (
      ...
      (a.urlThumb = e.data("thumb")),
        (a.title = e.data("title")),
        (a.objThumbImage = null),
        (a.urlImage = e.data("image"));
    }
    if (1 == i) {
      var _ = e.data("thumb-mobile");
      "undefined" != typeof _ &&
        "" != _ &&
        ((a.urlThumb = _), "img" == n && e.attr("src", a.urlThumb));
    ...
    c &&
      ...
      ((a.thumbWidth = c),
      (a.thumbHeight = h),
      (a.thumbRatioByWidth = c / h),
      (a.thumbRatioByHeight = h / c)),
      (a.addHtml = null);
    ...
    switch (a.type) {
      case "youtube":
        if (((a.videoid = e.data("videoid")), p || f)) {
          ...
          p && (a.urlImage = m.preview),
            f &&
              ((a.urlThumb = m.thumb), "img" == n && e.attr("src", a.urlThumb));
        }
      ...
      case "vimeo":
        ...
        break;
      case "html5video":
        (a.videoogv = e.data("videoogv")),
          (a.videowebm = e.data("videowebm")),
          (a.videomp4 = e.data("videomp4")),
    ...
    return (
      a.objThumbImage &&
        (a.objThumbImage.removeAttr("data-description", ""),
        a.objThumbImage.removeAttr("data-image", ""),
        a.objThumbImage.removeAttr("data-thumb", ""),
        a.objThumbImage.removeAttr("title", "")),
      a
    );
  }
  ...
  (this.onItemBigImageLoaded = function (e, t) {
    ...
    (this.resetPlaying = function () {
      return 0 == g_temp.isPlayMode
        ? !0
        : ((g_temp.playTimePassed = 0),
          void (g_temp.playTimeLastStep = jQuery.now()));
    }),
    (this.pausePlaying = function () {
      return 1 == g_temp.isPlayModePaused
        ? !0
    ...
    (this.continuePlaying = function () {
      return 0 == g_temp.isPlayModePaused
        ? !0
        : ((g_temp.isPlayModePaused = !1),
          (g_temp.playTimeLastStep = jQuery.now()),
    ...
    (this.isFullScreen = function () {
      return 1 == g_temp.isFakeFullscreen
        ? !0
        : 1 == g_functions.isFullScreen()
        ? !0
        : !1;
    }),
...
function UGLightbox() {
  function e(e, i) {
    (ie = e),
      ...
      "compact" == ae.lightbox_type &&
        ((se.isCompact = !0),
        (ae = jQuery.extend(ae, ue)),
        (ae = jQuery.extend(ae, i))),
      t(),
      1 == se.putSlider
        ? (ie.initSlider(ae, "lightbox"),
          (g_objects = e.getObjects()),
          (ne = g_objects.g_objSlider))
        : (ne = null),
      1 == ae.lightbox_show_textpanel
        ? oe.init(ie, ae, "lightbox")
        : (oe = null);
  }
  function t() {
    1 == se.isCompact &&
      1 == ae.lightbox_show_textpanel &&
      (ae.lightbox_slider_image_padding_bottom = se.initTextPanelHeight),
      1 == se.isCompact &&
        "inside" == ae.lightbox_arrows_position &&
        (se.isArrowsInside = !0),
      1 == se.isArrowsInside &&
        0 == ae.lightbox_arrows_inside_alwayson &&
        (se.isArrowsOnHoverMode = !0),
      0 == ae.lightbox_show_textpanel &&
        ((se.isTopPanelEnabled = !1),
        (se.topPanelHeight = 0),
        (ae.lightbox_slider_image_padding_top = 0));
  }
  function i() {
    var e = "",
      t = "";
    1 == se.isCompact && (t = " ug-lightbox-compact"),
      ...
      0 == se.isCompact &&
        1 == se.isTopPanelEnabled &&
        (($ = V.children(".ug-lightbox-top-panel")),
        0 == $.length && ($ = null)),
  ...
  function n() {
    if (
      (null !== ae.lightbox_overlay_color &&
        X.css("background-color", ae.lightbox_overlay_color),
      null !== ae.lightbox_overlay_opacity &&
        X.fadeTo(0, ae.lightbox_overlay_opacity),
      $ &&
        null !== ae.lightbox_top_panel_opacity &&
        $.children(".ug-lightbox-top-panel-overlay").fadeTo(
          0,
          ae.lightbox_top_panel_opacity
        ),
      J)
    ) {
      var e = {};
      null !== ae.lightbox_numbers_size &&
        (e["font-size"] = ae.lightbox_numbers_size + "px"),
        ae.lightbox_numbers_color && (e.color = ae.lightbox_numbers_color),
        null !== ae.lightbox_numbers_padding_right &&
          (e["padding-right"] = ae.lightbox_numbers_padding_right + "px"),
        null !== ae.lightbox_numbers_padding_top &&
          (e["padding-top"] = ae.lightbox_numbers_padding_top + "px"),
        J.css(e);
    }
  }
  function r(e) {
  ...
  function o(e) {
    ...
    var i = t,
      n = oe.getSize(),
      o = n.height;
    t != se.topPanelHeight && (i = se.topPanelHeight),
      o > i && (i = o),
      t != i && ($.height(i), ne && 0 == ne.isAnimating() && r(i));
  }
  function a(e) {
    var t = {},
    ...
    i > a
      ...
      : ((t.textpanel_padding_left = Math.floor((e.width - i) / 2)),
        ...
        ae.lightbox_textpanel_title_text_align &&
  ...
  function d(e, t) {
    ...
    (se.textPanelTop = e.bottom),
      t === !0 && oe.positionPanel(se.textPanelTop, se.textPanelLeft);
  }
  function _(e) {
    ...
    var a = u(i);
    0 == a &&
      ((se.positionFrom = "handleCompactTextpanelSizes"),
      oe &&
        (oe.positionPanel(se.textPanelTop, se.textPanelLeft),
        e === !0 && (e(), j())));
  }
  function g() {
  ...
  function c(e, t) {
    ...
    if (
      (Z.show(),
      q.show(),
      (se.positionFrom = "positionArrowsInside"),
      1 == se.isArrowsOnHoverMode && 1 == i && 0 == y() && I(!0),
      0 == i)
    )
      ...
      var s = ne.getSlideImage(),
        ...
        n =
          ...
          re.getElementRelativePos(Z, "left", 0, s) +
            l.left +
            ae.lightbox_arrows_inside_offset),
        r = re.getElementRelativePos(Z, "middle", 0, s) + l.top,
        o =
          re.getElementRelativePos(Z, "right", 0, s) +
          l.left -
          ae.lightbox_arrows_inside_offset,
        a = r;
    if (t === !0) {
      var u = { left: n, top: r },
        d = { left: o, top: a };
      Z.stop().animate(u, { duration: se.fadeDuration }),
        q.stop().animate(d, { duration: se.fadeDuration });
    } else
  ...
  function h(e, t) {
    ...
    if (0 == i)
      ...
      var a =
          ...
          l.right -
          d.width / 2 +
          ae.lightbox_compact_closebutton_offsetx,
        o =
          u.top +
          l.top -
          d.height / 2 -
          ae.lightbox_compact_closebutton_offsety;
      n > o && (o = n), a > r && (a = r);
    }
    if (t === !0) {
      var _ = { left: a, top: o };
  ...
  function p() {
    K && K.stop().fadeTo(se.fadeDuration, 0),
      v(),
      b(),
      (se.positionFrom = "hideCompactElements"),
      1 == se.isArrowsInside && I();
  }
  function f() {
    K && K.hide(),
      Z && 1 == se.isArrowsInside && (Z.hide(), q.hide()),
      J && J.hide(),
      oe && oe.hide();
  }
  function m() {
    ...
    $ && re.setElementSizeAndPosition($, 0, 0, e.width, se.topPanelHeight),
      Z &&
        0 == se.isArrowsInside &&
        (1 == ae.lightbox_hide_arrows_onvideoplay && (Z.show(), q.show()),
        re.placeElement(Z, "left", "middle", ae.lightbox_arrows_offset),
        re.placeElement(q, "right", "middle", ae.lightbox_arrows_offset)),
      0 == se.isCompact && re.placeElement(K, "right", "top", 2, 2),
      oe &&
        ((se.positionFrom = "positionElements"),
        0 == se.isCompact ? a(e) : (x(), j()));
    var t = e.width,
      i = e.height,
      n = 0,
      r = 0;
  ...
  function I(e, t) {
    return Z
      ? 1 == se.isArrowsOnHoverMode && t === !1
        ? (1 == y(), !0)
        : void (e === !0
            ? (Z.stop().fadeTo(0, 0), q.stop().fadeTo(0, 0))
            : (Z.stop().fadeTo(se.fadeDuration, 0),
              q.stop().fadeTo(se.fadeDuration, 0)))
      : !1;
  }
  function w() {
    if (!Z) return !0;
  ...
  function E(e, t) {
    return Z
      ? 1 == se.isArrowsOnHoverMode && t !== !0 && 1 == g()
        ? !0
        : 1 == ne.isSwiping()
        ? !0
        : (e !== !0 && (Z.stop(), q.stop()),
          Z.fadeTo(se.fadeDuration, 1),
          void q.fadeTo(se.fadeDuration, 1))
      : !1;
  }
  function T(e) {
  ...
  function x() {
    return oe
      ? void oe.getElement().show().stop().fadeTo(se.fadeDuration, 1)
      : !1;
  }
  function j() {
  ...
  function O(e, t) {
    return (
      ...
      0 == se.isCompact
        ...
        ? !0
        : ((se.positionFrom = "onSliderAfterPutImage"), h(!0), c(!0), void _())
    );
  }
  function z() {
    var e = ne.getOptions(),
    ...
    if (1 == se.isCompact) {
      if (
        (S(),
        P(),
        (se.positionFrom = "onSliderTransitionEnd"),
        h(!0),
        c(!0),
  ...
  function L(e, t) {
    0 == se.isCompact
      ? (J && P(t),
        oe &&
          (S(t),
          0 == se.isRightNowOpened &&
            (oe.positionElements(!1), o("onchange"), oe.positionPanel())))
      : 0 == ne.isAnimating() && (oe && S(t), J && P(t)),
      0 == se.isSliderChangedOnce &&
        ((se.isSliderChangedOnce = !0), te.trigger(ee.events.LIGHTBOX_INIT));
  }
  function H(e, t) {
  ...
  function k() {
    $ ? s() : J && J.hide(),
      Z && 1 == ae.lightbox_hide_arrows_onvideoplay && (Z.hide(), q.hide());
  }
  function R() {
    $ ? (l(), o("onStopVideo")) : J && J.show(),
      Z && 1 == ae.lightbox_hide_arrows_onvideoplay && (Z.show(), q.show());
  }
  function G(e, t, i) {
    var n = !1;
    switch (t) {
  ...
  function Q(e) {
    (se.positionFrom = "hideCompactElements"),
      1 == se.isArrowsOnHoverMode && 1 == g() && I(!1, !0);
  }
  function W(e) {
    ...
    1 == t &&
      y() &&
      0 == ne.isAnimating() &&
      ((se.positionFrom = "onMouseMove"),
      Z && 0 == Z.is(":animated") && E(!1, !0));
  }
  function B(e, t, i, n) {
  ...
  function F() {
    if (
      ...
      jQuery(ne).on(ne.events.TRANSITION_END, z),
        jQuery(ne).on(ne.events.CLICK, H);
    ...
    jQuery(window).resize(function () {
      return 0 == se.isOpened
        ? !0
        : void re.whenContiniousEventOver("lightbox_resize", N, 100);
    }),
      U.on(ie.events.GALLERY_KEYPRESS, G),
      1 == se.isArrowsOnHoverMode && jQuery(document).bind("mousemove", W),
      V.on("mousewheel", B);
  }
  function Y() {
    (se.isCompact = !1),
      t(),
      (se.isArrowsInside = !1),
      (se.isArrowsOnHoverMode = !1),
      (ae = jQuery.extend({}, se.originalOptions)),
      (ae.lightbox_arrows_position = "sides"),
      ne.setOptions(ae);
  }
  var U,
    V,
  ...
  (this.destroy = function () {
    ...
    jQuery(window).unbind("resize"),
      U.off(ie.events.GALLERY_KEYPRESS, G),
      V.off("mousewheel"),
      V.remove();
  }),
...
function UGCarousel() {
  ...
  function t(e) {
    ...
    N.append(t),
      (R = N.children(".ug-carousel-wrapper")),
      (G = R.children(".ug-carousel-inner")),
      F.setHtml(G),
  ...
  function n() {
    ...
    if (V.tileWidth < V.initTileWidth) {
      ...
      var t = B.getNumItemsInSpace(
        V.carouselMaxWidth,
        e,
        U.carousel_space_between_tiles
      );
    } else {
      var t = B.getNumItemsInSpace(
        V.carouselMaxWidth,
        ...
        ? (z(),
          ...
          jQuery.each(k, function (e, t) {
            t.objThumbWrapper.data("index", e),
              N.trigger(V.eventSizeChange, [t.objThumbWrapper, !0]),
              (t.objTileOriginal = t.objThumbWrapper.clone(!0, !0));
          }),
          m(!0),
          1 == U.carousel_autoplay && D.startAutoplay())
        : (1 == U.carousel_autoplay && D.pauseAutoplay(),
          w(0, !1),
          1 == U.carousel_autoplay && D.startAutoplay()),
      P(),
      (V.isFirstTimeRun = !1);
  ...
  function m(e) {
    ...
    return (
      jQuery.each(i, function (e, o) {
        ...
        (n += a.width + U.carousel_space_between_tiles),
          (r = Math.max(r, a.height)),
          e == i.length - 1 && (t = a.right);
      }),
      G.width(t),
  ...
  function b(e, t) {
    ...
    jQuery.each(r, function (e, i) {
      "left" == t ? G.prepend(i) : G.append(i),
        N.trigger(V.eventSizeChange, i),
        F.loadTileImage(i);
    });
  }
  function y(e, t) {
  ...
  function S() {
    ...
    if (
      (t > V.spaceActionSize
        ? ((n = s(t)), b(n, "right"))
        : t < -V.spaceActionSize && ((o = s(Math.abs(t))), y(o, "right")),
      o > a)
    )
  ...
  function x() {
    "left" == U.carousel_autoplay_direction
      ? D.scrollRight(1)
      : D.scrollLeft(1);
  }
  function j(e) {
  ...
  function C(e) {
    ...
    var t = null;
    if (
      (1 == U.carousel_vertical_scroll_ondrag &&
        (t = B.handleScrollTop(V.storedEventID)),
      "vert" === t)
    )
      return !0;
    V.lastMousePos = o(e);
    ...
    n > 0 && "prev" == r && (n /= 3),
      -a > n && "next" == r && (n = V.startInnerPos + i / 3),
      I(n);
  }
  function A(e) {
    return 0 == V.touchActive
      ? !0
      : ((V.touchActive = !1), T(), void D.unpauseAutoplay());
  }
  function M(e) {
    return 0 == U.carousel_autoplay_pause_onhover
      ? !0
      : void (1 == V.isPlayMode && 0 == V.isPaused && D.pauseAutoplay());
  }
  function O(e) {
    return 0 == U.carousel_autoplay_pause_onhover
      ? !0
      : void D.unpauseAutoplay();
  }
  function z() {
    F.initEvents(),
  ...
  (this.startAutoplay = function () {
    (V.isPlayMode = !0),
      (V.isPaused = !1),
      Q.trigger(D.events.START_PLAY),
      V.handle && clearInterval(V.handle),
      (V.handle = setInterval(x, U.carousel_autoplay_timeout));
  }),
    (this.unpauseAutoplay = function () {
      return 0 == V.isPlayMode
        ? !0
        : 0 == V.isPaused
        ? !0
        : void D.startAutoplay();
    }),
    (this.pauseAutoplay = function () {
      return 0 == V.isPlayMode
        ...
        : ((V.isPaused = !0),
          V.handle && clearInterval(V.handle),
          void Q.trigger(D.events.PAUSE_PLAY));
    }),
    (this.stopAutoplay = function () {
      return 0 == V.isPlayMode
        ...
        : ((V.isPaused = !1),
          (V.isPlayMode = !1),
          V.handle && clearInterval(V.handle),
          void Q.trigger(D.events.STOP_PLAY));
    }),
    (this.destroy = function () {
      V.handle && clearInterval(V.handle),
  ...
  function e(e, t) {
    (u = e),
      ...
      "select" == d.tabs_type
        ...
        : (s = jQuery(d.tabs_container + " .ug-tab"));
  }
  function t() {
    o();
  }
...
function UGLoadMore() {
  function e() {
    return (
      ...
      0 == o.length
        ? !1
        : ((a = o.find(".ug-loadmore-button")),
          0 == a.length
            ? !1
            : ((s = o.find(".ug-loadmore-loader")),
              0 == s.length
                ? !1
                : ((l = o.find(".ug-loadmore-error")),
                  0 == l.length ? !1 : void (d.isInited = !0))))
    );
  }
  function t() {
    o.show();
  ...
  !(function (e, t) {
    ...
    function n(t) {
      ...
      return (
        ...
        n.length
          ? ("0,0,0,0" === n.join() && e.extend(n, o.transparent), i)
          : o[t]
      );
    }
    function r(e, t, i) {
    ...
    (c.style.cssText = "background-color:rgba(1,1,1,.5)"),
              ...
              ? (r instanceof u
                  ...
                  : h(d, function (t, n) {
                      ...
                      h(n.props, function (e, t) {
                        ...
                        _[o] &&
                          e.inArray(null, _[o].slice(0, 3)) < 0 &&
                          ((_[o][3] = 1), n.from && (_._rgba = n.from(_[o])));
                    }),
                this)
              : void 0
          );
        ...
        return (
          (t =
            l === s
              ...
              ? (60 * (o - n)) / u + 120
              : (60 * (n - r)) / u + 240),
          (i = 0 === u ? 0 : 0.5 >= _ ? u / d : u / (2 - d)),
          [Math.round(t) % 360, i, _, null == a ? 1 : a]
        );
      }),
      (d.hsla.from = function (e) {
        ...
        var t = e[0] / 360,
          ...
          s = 2 * n - a;
        return [
          Math.round(255 * r(s, a, t + 1 / 3)),
          Math.round(255 * r(s, a, t)),
          Math.round(255 * r(s, a, t - 1 / 3)),
          o,
        ];
      }),
...
function UGTheme_tiles() {
  function e(e, n) {
    (p = e),
      ...
      c.init(e, T),
      f.init(e, T),
      (y = c.getObjTileDesign());
  }
  function t() {
    switch (
      (1 == T.theme_enable_preloader && (v.showPreloader = !0),
      T.theme_appearance_order)
    ) {
      default:
      case "normal":
        break;
  ...
  function n() {
    _.addClass("ug-theme-tiles"),
      _.append(
        "<div class='ug-tiles-wrapper' style='position:relative'></div>"
      ),
      1 == v.showPreloader &&
        (_.append("<div class='ug-tiles-preloader ug-preloader-trans'></div>"),
        (h = _.children(".ug-tiles-preloader")),
        h.fadeTo(0, 0)),
      (g = _.children(".ug-tiles-wrapper")),
      T.theme_gallery_padding &&
        _.css({
  ...
  function i() {
    h &&
      (h.fadeTo(0, 1),
      _.height(T.theme_preloading_height),
      m.placeElement(h, "center", T.theme_preloader_vertpos)),
      u(),
      c.run(),
      f.run();
  }
  ...
  function a() {
    null !== T.theme_auto_open &&
      (f.open(T.theme_auto_open), (T.theme_auto_open = null));
  }
  function u() {
    h &&
      p.onEvent(c.events.TILES_FIRST_PLACED, function () {
        _.height("auto"), h.hide();
      }),
      jQuery(y).on(y.events.TILE_CLICK, o),
      l.on(p.events.GALLERY_BEFORE_REQUEST_ITEMS, s),
      jQuery(f).on(f.events.LIGHTBOX_INIT, a);
  }
  var l,
    d,
    _,
    ...
    v = { showPreloader: !1 };
  (this.destroy = function () {
    jQuery(y).off(y.events.TILE_CLICK),
      p.destroyEvent(c.events.TILES_FIRST_PLACED),
      l.off(p.events.GALLERY_BEFORE_REQUEST_ITEMS),
